...
warm_path = 'warm/{}_{}.pt'.format(dataset, model_name)
...
sentence_encoder = mrconre.encoder.BERTEntityLMEncoder(
    max_length=128,
...
model = mrconre.model.BagAttention(
...
writer = None
framework = mrconre.framework.BagRE(
    model=model,
    writer=writer,
    train_path='../benchmark/{}/{}_train_pattern.txt'.format(dataset, dataset),
    val_path=None,
